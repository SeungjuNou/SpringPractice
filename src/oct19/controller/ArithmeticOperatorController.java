...
public class ArithmeticOperatorController {
	...
	public String add(@RequestParam("op1") int op1,
		@RequestParam("op2") int op2, Model model) {

		model.addAttribute("result", op1 + op2);
		return "oct19/math/result";
	}

	@RequestMapping("/math/subtract.do")
	public String subtract(@RequestParam("op1") int op1,
		@RequestParam("op2") int op2, Model model) {
	...
	public String multiply(@RequestParam("op1") int op1,
		@RequestParam("op2") int op2, Model model) {
